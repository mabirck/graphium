...
class Configuration:
    ...
    urban_highway_tipes         = ["tertiary", "road", "residential", "service", "living_street", "pedestrian", "bus_guideway", "steps","secondary"]
    motorways_highway_tipes     = ["motorway", "trunk", "primary", "escape"]
